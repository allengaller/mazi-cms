<?php
/**
 * TOP API: taobao.xhotel.gift.relationship.delete request
 * 
 * @author auto create
 * @since 1.0, 2013-12-10 16:57:25
 */
class XhotelGiftRelationshipDeleteRequest
{
	/** 
	 * 礼包ID
	 **/
	...
	/** 
	 * relate_id
当TYPE=1时，relate_id填写1，表示设置卖家级别礼包
当TYPE=2时，relate_id填HID
当TYPE=3时，relate_id填GID
当TYPE=4时，relate_id填[GID+RPID]
	 **/
	private $relateId;
	...
	{
		return "taobao.xhotel.gift.relationship.delete";
	}
